...
class EnquiriesControllerTest < ActionController::TestCase
  ...
  test "should create enquiry" do
    assert_difference('Enquiry.count') do
      post :create, enquiry: { Email: @enquiry.Email, Message: @enquiry.Message, Name: @enquiry.Name, Telephone: @enquiry.Telephone }
    end
  ...
  test "should update enquiry" do
    patch :update, id: @enquiry, enquiry: { Email: @enquiry.Email, Message: @enquiry.Message, Name: @enquiry.Name, Telephone: @enquiry.Telephone }
    assert_redirected_to enquiry_path(assigns(:enquiry))
  end
